...
export const metadata: Metadata = {
  ...
  description: 'Learn how Dytto collects, uses, and protects your personal context data.',
  alternates: { canonical: 'https://dytto.app/privacy' },
};
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 mb-12">
            ...
            <p className="text-blue-800 dark:text-blue-200">
              Dytto collects personal context data to help AI understand you better. You control
              what&apos;s collected, who can access it, and can delete it anytime. We never sell your
              data.
            </p>
          </div>
          ...
          <div className="space-y-12 text-slate-700 dark:text-slate-300">
              ...
              <div className="space-y-4 ml-9">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-white">
                    Context Data (with your permission)
                  </h3>
                  <ul className="list-disc list-inside space-y-1 mt-2">
                    <li>
                      <strong>Location:</strong> Places you visit, travel patterns
                    </li>
                    <li>
                      <strong>Activity:</strong> Daily routines, exercise, sleep
                    </li>
                    <li>
                      <strong>Calendar:</strong> Events, availability, commitments
                    </li>
                    <li>
                      <strong>Health:</strong> Steps, sleep, workouts (via Apple Health / Google Fit)
                    </li>
                    <li>
                      <strong>Financial:</strong> Transactions, balances (via Plaid, if you connect)
                    </li>
                    <li>
                      <strong>Social:</strong> Contact frequency, communication patterns
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="space-y-4 ml-9">
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <strong>Generate insights:</strong> Daily stories, behavioral patterns, life trends
                  </li>
                  <li>
                    <strong>Power AI agents:</strong> Provide context to AI assistants you authorize
                  </li>
                  <li>
                    <strong>Improve the service:</strong> Make Dytto smarter and more useful for you
                  </li>
                </ul>
            ...
            <section>
              ...
              <div className="space-y-4 ml-9">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <strong>AI agents you explicitly authorize</strong> — Each agent shows what data
                    it requests, and you approve or deny
                  </li>
                  <li>
                    <strong>Service providers</strong> — Infrastructure providers who process data on
                    our behalf under strict agreements
                  </li>
                  <li>
                    <strong>Legal requirements</strong> — If required by law or to protect safety
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 ml-9">
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    { title: 'Access', desc: 'View all data we have about you, anytime in the app.' },
                    { title: 'Export', desc: 'Download your data in a portable format.' },
                    { title: 'Delete', desc: 'Request complete deletion of your account and data.' },
                    { title: 'Revoke', desc: 'Disconnect any data source or AI agent at any time.' },
                  ].map((r) => (
                    <div key={r.title} className="bg-slate-50 dark:bg-slate-700/30 rounded-lg p-4">
                      <h4 className="font-semibold text-slate-900 dark:text-white mb-2">{r.title}</h4>
