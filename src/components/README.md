...
-   **Dynamic Navigation:**
    -   On the `/api` page, it displays section links for 'Platform', and 'API'.
...
-   **Page Navigation:** Always displays links to main pages: 'App' (homepage), 'API', 'Blog', 'Demo', and 'Feedback', conditionally hiding the link to the current page.
